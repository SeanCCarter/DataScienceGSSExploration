...
label values relpersn gsp001x;
label values trust    gsp002x;
label values health   gsp003x;
label values happy    gsp004x;
label values vote12   gsp005x;
label values partyid  gsp006x;
label values region   gsp007x;
label values born     gsp008x;
label values sex      gsp009x;
label values industry gsp010x;
label values wrkgovt  gsp011x;
label values hrs2     gsp012x;
